        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="border border-yellow-400 bg-primary text-black  hover:opacity-75 transition-opacity rounded-2xl font-semibold p-[5px] w-full mt-5 cursor-pointer items-center"
                >
                    Proceed to Buy
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={()=>{buyNow() ; closeModal()}} type="button" className="focus:outline-none w-full text-white bg-primary bg-primary-600 border-yellow-400 hover:opacity-75 transition-opacity  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 cursor-pointer" >Buy Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
